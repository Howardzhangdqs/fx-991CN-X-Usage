(() => {
	...
	var defaultOptions = {
		...
		website: "https://github.com/Howardzhangdqs/fx-991CN-X-Usage",
	};
	...
	function plugin(hook, vm) {
		...
		hook.afterEach(function (html, next) {
			let str = wordsCount + " 字";
			let readTime = Math.ceil(wordsCount / 400) + " 分钟";
			...
			next(
				...
				}: ${defaultOptions.margin};"><span style="float: ${
					defaultOptions.float === "right" ? "right" : "left"
				};font-size:${defaultOptions.fontsize};color:${
